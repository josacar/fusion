...
export const zhMessages: PartialMessages = {
  ...
  "shortcuts.action.focusNextItem": "聚焦下一个侧边栏项目",
  "shortcuts.action.focusPreviousItem": "聚焦上一个侧边栏项目",
  ...
  "shortcuts.action.openFocusedItem": "打开聚焦的侧边栏项目",
  "shortcuts.action.openNextItem": "聚焦并打开下一个侧边栏项目",
  "shortcuts.action.openOriginal": "打开原文",
  "shortcuts.action.openPreviousItem": "聚焦并打开上一个侧边栏项目",
  ...
  "shortcuts.action.toggleGroup": "展开或折叠分组",
